...
## Задача 1:
Създайте енумерация Crop, представляваща различни растителни култури, които могат да бъдат засаждани. Стойностите да са: {WHEAT, BARLEY, CORN, NOTHING}.
...
## Задача 2:
Да се създаде енумерация Genre, описваща жанрове на книги. Стойностите да са: {ROMANCE, HORROR, MYSTERY, SCIENCE_FICTION, FANTASY}.
