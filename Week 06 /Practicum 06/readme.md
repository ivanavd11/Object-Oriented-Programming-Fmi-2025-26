...
### Задача 3:
Да се създаде клас HexColourCode, който репрезентира кодиране на цвят от тип hexcode - повече информация можете да намерите тук. Класът да има следните полета и член-функции:
